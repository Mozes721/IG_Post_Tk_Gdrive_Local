...
BUFSIZE = 8192
CLIP = 0
DATETIMEUNITS = _mod___builtin__.PyCObject()
ERR_CALL = 3
ERR_DEFAULT = 521
ERR_IGNORE = 0
ERR_LOG = 5
...
USE_SETITEM = 64
WRAP = 1
_ARRAY_API = _mod___builtin__.PyCObject()
_UFUNC_API = _mod___builtin__.PyCObject()
__doc__ = None
__file__ = '/usr/lib/python2.7/dist-packages/numpy/core/_multiarray_umath.x86_64-linux-gnu.so'
__name__ = 'numpy.core._multiarray_umath'
__package__ = None
__version__ = '3.1'
...
_flagdict = _mod___builtin__.dict()
def _get_implementing_args():
...
class broadcast(_mod___builtin__.object):
...
class busdaycalendar(_mod___builtin__.object):
...
def divide(x1, x2, out=None, *, where=True, casting='same_kind', order='K', dtype=None, subok=True, signature=None, extobj=None):
...
class dtype(_mod___builtin__.object):
...
error = _mod_exceptions.Exception
...
class flagsobj(_mod___builtin__.object):
    __class__ = flagsobj
    def __cmp__(self):
        'x.__cmp__(y) <==> cmp(x,y)'
        pass
...
class flatiter(_mod___builtin__.object):
...
def matmul(x1, x2, out=None, *, casting='same_kind', order='K', dtype=None, subok=True, signature=None, extobj=None):
...
class ndarray(_mod___builtin__.object):
...
class nditer(_mod___builtin__.object):
...
typeinfo = _mod___builtin__.dict()
